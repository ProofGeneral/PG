...
(defvar coq-other-commands-db
  '(
    ...
    ("Admit Obligations" "oblsadmit" "Admit Obligations." t "Admit\\s-+Obligations")
    ...
    ("Extract Constant" "extrc" "Extract Constant @{id} => \"@{id}\"." t "Extract\\s-+Constant")
    ("Extract Inlined Constant" "extric" "Extract Inlined Constant @{id} => \"@{id}\"." t "Extract\\s-+Inlined\\s-+Constant")
    ("Extract Inductive" "extri" "Extract Inductive @{id} => \"@{id}\" [\"@{id}\" \"@{id...}\"]." t "Extract")
