...
;; TODO: needs update according to documentation in proof-tree-update-goal-regexp
...
(setq 
 ...
 ;; prooftree deconfigured for Hol-Light, because at least
 ;; hol-light-update-goal-regexp needs an update
 proof-tree-configured nil
